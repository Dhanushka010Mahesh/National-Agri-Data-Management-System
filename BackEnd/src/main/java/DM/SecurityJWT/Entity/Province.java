...
public enum Province {
    ...
    Central_Province,  // Includes Kandy, Matale, and Nuwara Eliya.
    Sabaragamuwa_Province, // Includes Kegalle and Rathnapura.
    Eastern_Province, // Includes Ampara, Batticaloa, and Trincomalee.
