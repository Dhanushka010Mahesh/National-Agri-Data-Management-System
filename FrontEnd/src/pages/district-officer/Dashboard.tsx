    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium">Division Offices</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-primary mr-3" viewBox="0 0 20 20" fill="currentColor">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium">Division Officers</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-primary mr-3" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Division Officers</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="card-hover">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-3">Colombo District</h3>
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-500">Division Offices:</span>
                  ...
                  <Button variant="outline" className="w-full" asChild>
                    <Link to="/District_Officer/d1">Manage District</Link>
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="card-hover">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-3">Kandy District</h3>
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-500">Division Offices:</span>
                      <span className="font-medium">2</span>
                  ...
                  <Button variant="outline" className="w-full" asChild>
                    <Link to="/District_Officer/d2">Manage District</Link>
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="card-hover">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-3">Galle District</h3>
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-500">Division Offices:</span>
                      <span className="font-medium">2</span>
                  ...
                  <Button variant="outline" className="w-full" asChild>
                    <Link to="/District_Officer/d3">Manage District</Link>
                  </Button>
                </CardContent>
              </Card>
            </div>
